...
def compute_life_point_reward(state: dict, next_state: dict) -> float:
    ...
    player_lp_diff = (afeter_action_player_lp - player_lp) / MAX_LP_POINT  # 1step前からどの程度LPが減っているか
    enemy_lp_diff = (afeter_action_enemy_lp - enemy_lp) / MAX_LP_POINT  # 1step前からどの程度LPが減っているか
