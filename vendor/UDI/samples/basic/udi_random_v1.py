...
def _execute_random_command(udi_io: UdiIO, text_util: util_text.TextUtil) -> bool:
    # 実行可能なコマンドを取得
    ...
    if score < 0.5:
        ...
        udi_io.output_rating_text([
            ...
            {"text": "青眼の白龍", "score": 0.50, "type": UdiIO.RatingTextType.CARD_ID, "id": 1004},
        ...
        while True:
            try:
                ...
                if udi_io.is_command_required():
                    _execute_random_command(udi_io, text_util)
                else:
                    continue
